...
export default async function(ctx) {
  const BG_COLORS = [
    { light: '#FDFBF7', dark: '#FDFBF7' },
    { light: '#E4EBDC', dark: '#E4EBDC' },
    { light: '#DEE5EE', dark: '#DEE5EE' },
    { light: '#C6D8E4', dark: '#C6D8E4' }
  ];
  const C_TITLE = { light: '#4A5568', dark: '#4A5568' };
  const C_SUB = { light: 'rgba(74,85,104,0.65)', dark: 'rgba(74,85,104,0.65)' };
  const C_GREEN = { light: '#A5C4B4', dark: '#A5C4B4' };
  const C_MAIN = { light: '#4A5568', dark: '#4A5568' };
  ...
  return {
    ...
    children: [
      ...
      { type: 'spacer', length: 10 },
      {
        ...
        gap: 4,
        children: [
          Row("house.fill", { light: '#95A5C3', dark: '#95A5C3' }, "本地 IP", lIp, C_GREEN),
          Row("map.fill", { light: '#95A5C3', dark: '#95A5C3' }, "本地位置", lLoc, C_MAIN),
          Row("antenna.radiowaves.left.and.right", { light: '#95A5C3', dark: '#95A5C3' }, "运营商", lIsp, C_MAIN),
          { type: 'spacer', length: 2 },
          Row("network", { light: '#CD939A', dark: '#CD939A' }, "落地 IP", nIp, C_GREEN),
          Row("mappin.and.ellipse", { light: '#CD939A', dark: '#CD939A' }, "落地位置", nLoc, C_MAIN),
          Row("server.rack", { light: '#CD939A', dark: '#CD939A' }, "运营商", nIsp, C_MAIN),
          Row("clock.fill", { light: '#D8B97B', dark: '#D8B97B' }, "执行时间", timeStr, C_GREEN)
        ]
      },
      { type: 'spacer' }
    ]
